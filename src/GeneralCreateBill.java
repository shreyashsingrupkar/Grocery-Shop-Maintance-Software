...
public class GeneralCreateBill extends javax.swing.JInternalFrame {
  ...
  private void billnumber(){
        try {
            ...
            String  billdatequery="SELECT MAX(BILL_DATE) FROM general_bill";
            ...
            if(lastdate.equals(date)){
                String  billnumquery="SELECT MAX(BILL_NUMBER) FROM general_bill";
                st=con.createStatement();
                ...
                if(rs.next()){
                    ...
                    if(getnumvalue==null){
                        billnum="G"+new SimpleDateFormat("ddMMyy").format(new Date())+"10001"; 
                    }
                    else{
                    ...
                    billnum="G"+new SimpleDateFormat("ddMMyy").format(new Date())+val;
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(CusMobTF, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(90, 90, 90)
        ...
        jLabel10.setBackground(new java.awt.Color(208, 211, 212));
        ...
        QuantityTF.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jLayeredPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BillNoTF, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(107, 107, 107)
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLayeredPane1Layout.createSequentialGroup()
                        .addComponent(BillNoTF, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)))
            ...
            try {
             ...
             String comma5="";
               ...
               String comma6="";
                ...
                String query="INSERT INTO `general_bill`( `BILL_NUMBER`, `BILL_DATE`, `CUSTOMER_NAME`, `CUSTOMER_MOBILE`, `CUSTOMER_ADDR`, `TOTAL`, `DISCOUNT`, `GRAND_TOTAL`, `PAYMENT_MODE`, `AMOUNT_PAID`, `BALANCE`, `P_T_N`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
                stmt=con.prepareStatement(query);
                stmt.setString(1,billnumber );
                stmt.setString(2,billdate );
                stmt.setString(3,cusname );
                 stmt.setString(4,cusmob );
                  stmt.setString(5,cusaddr );
                stmt.setString(6,total );
                stmt.setString(7,totaldiscount );
                stmt.setString(8,grandtotal );
                stmt.setString(9,paymentmode );
                stmt.setString(10,amountpaid );
                stmt.setString(11,balance );
                stmt.setString(12,pti );
                stmt.executeUpdate();
                
                
                 String query2="INSERT INTO `general_bill_item`( `BILL_NUMBER`, `ITEM_ID`,`ITEM_NAME`,`ITEM_PRICE`, `DISCOUNT`, `QUANTITY`, `SUB_TOTAL`) VALUES (?,?,?,?,?,?,?)";
               ...
               String sqlid1="ALTER TABLE general_bill DROP SR_NUM";
                    String sqlno1="ALTER TABLE general_bill ADD SR_NUM INT NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST";
